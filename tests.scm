...
(define suh (+ eval (define suh 40) 7))
; expect Error
...
'(1 . '(2 huh . (3 . 4)))
; expect (1 quote (2 huh 3 . 4))

;; Question 7
(begin (* 2 10) (/ 55 5) (/ 1 0))
; expect Error

(begin (begin 1 2 (begin 4 5) (begin 6 7) 8 (begin 9)))
; expect 9

(begin (define over 9000) (define dog (begin (define bigdog 100))))
; expect dog
...
(if (= 2 2) 'hello 'greetings 'whatsgood)
;expect Error

;; Question 14B
(or 'stophere (/ 1 0) False)
; expect stophere

(or )
; expect False

(if (and (cons True (cons False nil)) False) 33 66)
; expect 66
...
;; Question 17
(define tupac (mu (x) (+ x y)))
((lambda (h i) (tupac (+ h h ))) 4 10)
; expect Error

(define a (mu (x) (+ x y)))
; expect a

(define g (lambda (x y) (a (+ x x))))
; expect g
